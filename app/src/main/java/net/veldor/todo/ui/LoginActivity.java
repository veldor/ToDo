...
import net.veldor.todo.view_models.LoginViewModel;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void observeRequest(LiveData<WorkInfo> worker) {
        ...
        final LiveData<String> requestStatus = App.getInstance().mRequestStatus;
    ...
    private void notifyError() {
            Toast.makeText(this, mMyViewModel.handleError(), Toast.LENGTH_SHORT).show();
    }
