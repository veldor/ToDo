...
public class UpdateIncomingTaskListWorker extends Worker {
    ...
    public Result doWork() {
        try {
            ...
            String jsonInputString = "{\"cmd\":\"getIncomingTaskList\", \"token\":\"" + Preferences.getInstance().getToken() + "\"}";
            Log.d("surprise", "UpdateIncomingTaskListWorker doWork 47: request " + jsonInputString);
            ...
            try (BufferedReader br = new BufferedReader(
                ...
                if (response != null) {
                    Log.d("surprise", "UpdateIncomingTaskListWorker doWork 59: have response: " + response);
