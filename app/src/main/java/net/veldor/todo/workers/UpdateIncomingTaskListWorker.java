...
import static net.veldor.todo.workers.UpdateOutgoingTaskListWorker.FILTER_DATA;
import static net.veldor.todo.workers.UpdateOutgoingTaskListWorker.LIMIT_DATA;
import static net.veldor.todo.workers.UpdateOutgoingTaskListWorker.PAGE_DATA;
import static net.veldor.todo.workers.UpdateOutgoingTaskListWorker.SORT_DATA;
import static net.veldor.todo.workers.UpdateOutgoingTaskListWorker.SORT_REVERSE_DATA;
...
public class UpdateIncomingTaskListWorker extends ConnectWorker {
    ...
    public Result doWork() {
        try {
            ...
            String answer = handleRequest("getIncomingTaskList", args);
            if (answer != null) {
