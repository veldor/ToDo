...
public class FinishTaskWorker extends ConnectWorker {


    public static final String ACTION = "finish task";
    public static final String TASK_ID = "task id";

    public FinishTaskWorker(@NonNull Context context, @NonNull WorkerParameters workerParams) {
    ...
    public Result doWork() {
        try {
            ...
            String answer = handleRequest("finishTask", args);
            if (answer != null) {
