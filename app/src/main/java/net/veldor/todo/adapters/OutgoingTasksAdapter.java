...
//    }
    ...
    static class ViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener {
        ...
        private final TextView mExecutorView;
        ...
        public ViewHolder(WorkTaskItemBinding binding) {
            ...
            mExecutorView = root.findViewById(R.id.executorView);
        ...
        public void bind(TaskItem workingTask) {
            ...
            switch (workingTask.target){
                case "IT-отдел":
                    mExecutorView.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_baseline_it_department_icon_24, 0, 0, 0);
                    break;
                case "Офис":
                    mExecutorView.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_baseline_office_department_icon_24, 0, 0, 0);
                    break;
                case "Инженерная служба":
                    mExecutorView.setCompoundDrawablesWithIntrinsicBounds(R.drawable.ic_engeneer_department_icon_24, 0, 0, 0);
            }
        }
